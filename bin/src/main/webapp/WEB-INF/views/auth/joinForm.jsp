...
<body id="LoginForm">
	...
	<div class="container">
		...
		<div class="registration_datail">
			...
			<div>
				<div class="form">
					<label class="form-label">한글 성<a style="color: #e60000">*</a></label> <input type="text" class="form-control" id="firstname">
				</div>
			</div>

			<div>
				<div class="form">
					<label class="form-label">한글 이름<a style="color: #e60000">*</a></label> <input type="text" class="form-control" id="firstname">
				</div>
			</div>

			<div>
				<div class="form">
					<label class="form-label">영문 성<a style="color: #e60000">*</a></label> <input type="text" class="form-control" id="firstname">
				</div>
			</div>

			<div>
				<div class="form">
					<label class="form-label">영문 이름<a style="color: #e60000">*</a></label> <input type="text" class="form-control" id="firstname">
				</div>
			</div>
			...
			<div>
				<div class="form">
					...
					<input type="password" class="form-control" id="firstname" maxlength="20">
				</div>
			</div>
			...
			<div class="form-birthday">
				<label class="form-label">생년월일 (YYYY.MM.DD.)<a style="color: #e60000">*</a></label> <input type="number" class="form-control" id="birthday">
			</div>
			...
			<div>
				<div class="form">
					<label class="form-label">이메일<a style="color: #e60000">*</a></label> <input type="email" class="form-control" id="firstname">
				</div>
			</div>
			...
			<div>
				<div class="form">
					<label class="form-label">전화번호<a style="color: #e60000">*</a></label> <input type="tel" class="form-control" id="firstname" maxlength="11">
				</div>
			</div>
		...
		<div class="confirm_table">
			...
			<a href="agree.html" type="button" class="confirm_table_box1">취소</a> <a href="" type="button" class="confirm_table_box2">확인</a>
		</div>
	</div>
</body>
